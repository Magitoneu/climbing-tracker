...
import { SettingsGradeSystemScreen } from '../../grades';
...
export default function SettingsStack() {
  return (
    <Stack.Navigator initialRouteName="SettingsMenu" screenOptions={{ headerShown: true }}>
      ...
      <Stack.Screen
        name="GradeSystem"
        component={SettingsGradeSystemScreen}
        options={{ title: 'Grade System', headerBackTitle: 'Settings' }}
      />
      <Stack.Screen
        name="Language"
        component={SettingsLanguageScreen}
        options={{ title: 'Language', headerBackTitle: 'Settings' }}
      />
    </Stack.Navigator>
  );
}
