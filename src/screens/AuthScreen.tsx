...
import { createUserWithEmailAndPassword, signInWithEmailAndPassword, sendPasswordResetEmail, signInWithCredential, GoogleAuthProvider, signInWithPopup, signInWithRedirect } from 'firebase/auth';
...
const redirectUri = isStandalone
  ? makeRedirectUri({ scheme: 'climbingtracker' })
  : makeRedirectUri(); // default -> proxy in Expo Go
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: '#2563eb', padding: 14, borderRadius: 8, width: '100%', alignItems: 'center', marginBottom: 12 },
