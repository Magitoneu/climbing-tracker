...
const styles = StyleSheet.create({
  ...
  label: { fontWeight: '600', marginBottom: 4, color: '#0F172A' },
  nativeButton: { backgroundColor: '#FFFFFF', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: '#E2E8F0' },
  nativeButtonText: { fontSize: 16, fontWeight: '600', color: '#0F172A' },
